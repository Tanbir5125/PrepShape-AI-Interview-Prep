...
const useFaceDetection = ({ videoRef, isActive, onFaceCountChange })=>{
    ...
    const smoothBufferRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFaceDetection.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$face$2d$api$2e$js$2f$build$2f$es6$2f$globalApi$2f$nets$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["nets"].tinyFaceDetector.loadFromUri("/models").then({
                "useFaceDetection.useEffect": ()=>setModelsLoaded(true)
            }["useFaceDetection.useEffect"]);
        }
    }["useFaceDetection.useEffect"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useFaceDetection.useEffect": ()=>{
            ...
            const detect = {
                "useFaceDetection.useEffect.detect": async ()=>{
                    ...
                    const avg = smoothBufferRef.current.reduce({
                        "useFaceDetection.useEffect.detect": (a, b)=>a + b
                    }["useFaceDetection.useEffect.detect"], 0) / smoothBufferRef.current.length;
                    onFaceCountChange?.(Math.round(avg));
                }
            }["useFaceDetection.useEffect.detect"];
...
_s(useFaceDetection, "6rMd89lLtxW06jXiOkzVNxX9yWk=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
const Agent = ({ userName, userId, interviewId, feedbackId, type, questions })=>{
    ...
    /* ---------------- Anti-spam refs ---------------- */ const noFaceTimeoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const noFaceWarnedRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(false);
    /* ---------------- VAPI listeners ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Agent.useEffect": ()=>{
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vapi"].on("call-start", {
                "Agent.useEffect": ()=>setCallStatus("ACTIVE")
            }["Agent.useEffect"]);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vapi"].on("call-end", {
                "Agent.useEffect": ()=>setCallStatus("FINISHED")
            }["Agent.useEffect"]);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vapi"].on("message", {
                "Agent.useEffect": (message)=>{
                    if (message.type === "transcript" && message.transcriptType === "final") {
                        setMessages({
                            "Agent.useEffect": (prev)=>[
                                    ...prev,
                                    {
                                        role: message.role,
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vapi"].on("speech-start", {
                "Agent.useEffect": ()=>setIsSpeaking(true)
            }["Agent.useEffect"]);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vapi"].on("speech-end", {
                "Agent.useEffect": ()=>setIsSpeaking(false)
            }["Agent.useEffect"]);
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vapi"].on("error", console.error);
            return ({
                "Agent.useEffect": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vapi$2e$sdk$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vapi"].removeAllListeners()
            })["Agent.useEffect"];
        }
    }["Agent.useEffect"], []);
    /* ---------------- Handle end of call ---------------- */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Agent.useEffect": ()=>{
            if (messages.length) {
            ...
            const generateFeedback = {
                "Agent.useEffect.generateFeedback": async ()=>{
                    if (type === "generate") return router.push("/");
                    const { success } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$actions$2f$data$3a$64d437__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createFeedback"])({
            ...
            }["Agent.useEffect.generateFeedback"];
            generateFeedback();
        }
    }["Agent.useEffect"], [
        callStatus,
    ...
    /* ---------------- Face count logic ---------------- */ const handleFaceCountChange = (count)=>{
        ...
        /* ---- MULTIPLE PEOPLE ---- */ if (count > 1) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`⚠️ Multiple people detected (${count})`);
    ...
    /* ---------------- Call controls ---------------- */ const handleCall = async ()=>{
        if (!isCameraActive) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("Start your camera first");
            return;
        }
    ...
    /* ---------------- UI ---------------- */ return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            showViolationWarning && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(Agent, "8/290UwMoCN995KcBdG59OdXcII=", false, function() {
    return [
...
//# sourceMappingURL=_8ac59176._.js.map